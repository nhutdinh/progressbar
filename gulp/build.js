...
gulp.task('images', ['images-rename', 'html'] , function () {
  var manifest = gulp.src(path.join(conf.paths.dist + "/rev-manifest.json"));
  return gulp.src([path.join(conf.paths.dist, '/**/app-*.css'), path.join(conf.paths.dist, '/*.html'), path.join(conf.paths.dist, '/**/app-*.js')])
